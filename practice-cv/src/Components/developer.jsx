    ...
    <div className='developer-container flex flex-column flex-center color-primary'>
      ...
      <div className='developer-content flex flex-center flex-column'>
        ...
        <div className='education-container flex flex-column flex-center'>
          ...
          to use your skills in the worklife a company or organization.<br />
            Courses included:<br />
            ...
            To see our React school project, a recipe app called GlobeGrub, click: <a href='https://globegrub.netlify.app/'>here.</a>
            </li>
            <li>Clean code</li>
